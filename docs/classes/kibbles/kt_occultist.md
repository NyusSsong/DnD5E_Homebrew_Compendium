...
=== "Progression Table"
    ...
    --8<-- "kibbles/kt_occultist/progression.md"

=== "Core Occultist Features"

    --8<-- "kibbles/kt_occultist/core_features.md"

=== "Occultist Rites"

    --8<-- "kibbles/kt_occultist/rites.md"

=== "Occultist Spell List"

    --8<-- "kibbles/kt_occultist/spell_list.md"
