...
**Tools:** One from herbalism kit, an artisan tool, or a musical instrument  
...
#### Level 1 - Defensive Blessing

Starting at 1st level, the high powers which guide
...
At 2nd level, you gain the ability to channel divine energy directly from your deity, using that energy to fuel magical effects. You start three such effects: Turn Undead, Divine Spark, and an effect determined by your domain. Some domains grant you additional effects as you advance in levels, as noted in the domain description.
...
#### Level 3 - Signs of Faith

At 3rd level, you gain a sign of faith of your choice.
Signs of faith are detailed at the end of your class
description. The Signs Known column of the Cleric
table shows when you gain new signs.

<hr>

#### Level 5 - Empowered Channeling

At 5th level your greater entity grants you improved
ways to channel your divine energy through your divine symbol.
You gain this feature again at 8th, 11th, 14th, and 17th
level. Each time you gain Empowered Channeling,
choose one of the following:

**Command Undead.** If you choose, creatures you turn instead regard
you as their master for the duration. While they
are under this effect, you may use your action to
issue simple commands (no more than a sentence
or two) which they are compelled to obey. They
will not take any action that is obviously harmful
to them, and so will not leap from a great height,
jump onto a sword, or purposefully self-inflict
any damage. They follow the command until
you issue a new one.

**Destroy Undead.** Creatures turned by you of CR ½ or less are
immediately destroyed, transformed into dust
by a blinding flash of light. You can select this
option multiple times. Each time you choose it,
you are able to destroy more powerful creatures,
progressing to CR 1, CR 2, CR 3, and then CR
4 each subsequent time you select this option.

**Turn Supernatural.** Choose a creature type from celestial, elemental,
fey, or fiend. When you use Turn Undead, you
can also choose to affect creatures of that type.
You can select this option multiple times.

**Smite Undead.** You can cause your Turn Undead feature to smite the
undying. Whenever you use Turn Undead, you can roll
a number of d8s equal to your proficiency bonus and
add the rolls together. Each undead that fails the
saving throw against that use of Turn Undead takes
radiant damage equal to the roll's total. This
...
a number of d8s equal to your proficiency bonus and
add the rolls together. The creature you hit takes
additional radiant damage equal to the roll's total.

**Directed Channel.** The range for both of your basic Channel Divinity
features increases to 60 feet.

**Channel Flare.** When you use your basic Channel Divinity features,
instead of choosing a target within the normal
range of the feature, you can choose a 15-foot
radius area as the target that you can see
within the normal range. If you use your Divine
Spark basic feature, the roll's total is halved.
...
feature is reduced to 0 hit points, you can spend
your reaction to spend one use of your Channel
Divinity and use the basic feature upon yourself
or that creature.

<hr>

#### Level 7 - Divine Strength

Divine power infuses you in battle. You gain one of the following options of your choice:

**Divine Strike.** Once on each of your turns, when you hit a creature with a weapon attack, you can cause the target to take an additional 1d8 necrotic, radiant or thunder (your choice) damage. This damage increases to 2d8 at 14th level.

**Potent Spellcasting.** You add your Wisdom modifier to the damage you deal with any Cleric cantrip. At 14th level, when you deal damage to a creature with a Cleric cantrip, you can grant to yourself or another creature within 60 feet of yourself that you can see a number of temporary hit points equal to twice your Wisdom modifier.
...
At 20th level, you can choose *wish* when you select a spell. If you do so, you can't use Divine Intervention for a week.
