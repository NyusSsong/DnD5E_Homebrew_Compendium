...
<select id="alt-subclass-select" style="padding: 0.4em; border-radius: 6px; border: 1px solid #888; background: var(--md-default-bg-color); color: var(--md-typeset-color);">
    ...
    <option value="alternate-oath-of-vengeance">Alternate Oath of Vengeance</option>
</select>

<div class="subclass-content" data-subclass="alternate-oath-of-the-ancients">

??? subclass "Alternate Oath of the Ancients"
    ...
    ### Level 1 - Tenets of the Ancients
    ...
    **Light.** Delight in song, dance, and laughter. Spread joy through your actions.
    ...
    ### Level 20 - Avatar of the Ancients
    ...
    - Creatures within 30 feet have disadvantage on saving throws to resist Paladin spells.
...
<div class="subclass-content" data-subclass="alternate-oath-of-devotion">

??? subclass "Alternate Oath of Devotion"
    ...
    **Honor.** Do as much good as possible while causing the least amount of harm. Obey those with rightful authority.
    ...
    ### Level 1 - Extra Lay On Hands

    In addition to the hit points pool of your Lay On Hands ability, you can also use your bonus action to touch a creature and spend Divine Fervor (up to your Charisma modifier) and restore five hit points per Divine Fervor spent. Alternatively, you can use this feature to cure one disease or poison for each point of Divine Fervor spent. This feature has no effect on constructs or undead.
    ...
    As a bonus action, you can expend 1 Divine Fervor to infuse a melee weapon you are holding with holy power. For 1 minute, it becomes a magic weapon, you add your Charisma modifier to attack rolls with it, and it emits bright light out to 30 feet. These effects instantly end if you use your bonus action to dismiss them, or if another creature picks up this weapon.
    ...
    The purity of your devotion to the good of others protects you from powerful outside influences. You are always under the effects of a *protection from evil and good* spell.

    <hr>

    ### Level 20 - Avatar of Devotion
...
<div class="subclass-content" data-subclass="alternate-oath-of-vengeance">

??? subclass "Alternate Oath of Vengeance"
    ...
    **Restitution.** Make restitution for the evil of your Sworn Foes and other evildoers.
    ...
    If the creature is also a Sworn Foe, it has disadvantage on all attack rolls against creatures other than you for 1 minute. Only one creature can be under your Vow of Enmity at a time. Using this feature on another creature ends the effect of this vow for the previous creature.

    <hr>

    ### Level 7 - Aura of Vengeance
