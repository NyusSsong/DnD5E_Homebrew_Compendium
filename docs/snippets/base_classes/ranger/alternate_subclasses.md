...
<select id="alt-subclass-select" class="filter-select">
    ...
    <option value="alt-fey-wanderer">Alternate Fey Wanderer Conclave</option>
    <option value="alt-gloom-stalker">Alternate Gloom Stalker Conclave</option>
    <option value="alt-horizon-walker">Alternate Horizon Walker Conclave</option>
    <option value="alt-monster-slayer">Alternate Monster Slayer Conclave</option>
    <option value="alt-swarm-keeper">Alternate Swarm Keeper Conclave</option>
</select>

<div class="subclass-content" data-subclass="alt-hunter">

??? subclass "Alternate Hunter Conclave"
...
<div class="subclass-content" data-subclass="alt-drakewarden">

??? subclass "Alternate Drakewarden Conclave"

    Sometimes wandering Rangers enter into the service of great dragons and are gifted a portion of their power. Undergoing an ancient ritual, they are bound to a Draconic Companion, a powerful scion of an elder dragon. Known as Drakewardens, these Rangers fight alongside their Companions as powerful draconic servants, and can eventually become dragon riders.
    ...
    Your soul has been bound to that of a Draconic Companion. You gain the Animal Companion Knack, but it does not count against your total number of Knacks Known.

    You must choose a wyrmling dragon to become your companion, but the DM will modify the statblock to be in line with the typical Animal Companion limitations. Your draconic companion also loses its breath weapon.
    ...
    The magic that bonds you to your Companion has infused you with draconic power. You learn to speak, read, and write Draconic, and when you cast a Ranger spell that deals acid, cold, fire, lightning, or poison damage, you can cause it to deal the damage type of your companion's elemental instead.

    <hr>

    ### Level 7 - Greater Companion

    As your power increases, so does that of your Companion. If it hasn't, your companion becomes Medium in size, and can bear you as a rider so long as you are Medium or smaller. However, its flying speed is halved while you are riding it.

    <hr>

    ### Level 11 - Elemental Breath

    You and your companion can directly channel the elemental power of its element. As an action, you, or your companion, can exhale a 30-foot cone of elemental breath. Creatures in that area must make a Dexterity saving throw against your Ranger spell save DC. Creatures take 8d6 elemental damage on a failed save, and half as much damage on a success.
    ...
    Additionally, the damage of Elemental Breath increases to 12d6 damage.
...
<div class="subclass-content" data-subclass="alt-fey-wanderer">

??? subclass "Alternate Fey Wanderer Conclave"
...
<div class="subclass-content" data-subclass="alt-gloom-stalker">

??? subclass "Alternate Gloom Stalker Conclave"

    Deep beneath the earth where the light of the sun is a dream, nameless things dwell in the deep shadow. The Rangers who stand against these unspeakable terrors of the darkness are known as Gloom Stalkers. Though their skills were originally developed by denizens of the Underdark, Gloom Stalkers can be found guarding anywhere darkness lies heavy on the land.
...
<div class="subclass-content" data-subclass="alt-horizon-walker">

??? subclass "Alternate Horizon Walker Conclave"

    Horizon Walkers dedicate their lives to preserving the balance of the multiverse by defending their native plane of existence from otherworldly threats. Keeping watch over planar portals these esoteric warriors can draw on the power of the planes to destroy outsiders that would seek to invade their homes.
    ...
    Moreover, you can mark any creatures not native to your current plane of existence as your Quarry without expending a use of Ranger's Quarry. For example, while you are on the material plane, you can use this feature to mark aberrations, celestials, elementals, fey, and fiends, as your Quarry.
...
<div class="subclass-content" data-subclass="alt-monster-slayer">

??? subclass "Alternate Monster Slayer Conclave"
    ...
    You also have advantage when you take the Study a Creature action. Additionally, if you study your Quarry with this feature you can add one roll of your Quarry Die to your ability check.
...
<div class="subclass-content" data-subclass="alt-swarm-keeper">

??? subclass "Alternate Swarm Keeper Conclave"
