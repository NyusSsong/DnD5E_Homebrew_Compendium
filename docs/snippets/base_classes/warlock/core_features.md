...
**Saving Throws:** Intelligence/Charisma, Wisdom  
**Skills:** Two from Arcana, Deception, History, Intimidation, Investigation, Nature, and Religion  
...
You can unleash your patron's power as beams of arcane energy. You can use your action to make a ranged spell attack against a target you can see within 120 feet. On hit, it takes force damage equal to 1d10 + your spellcasting modifier.

<hr>

#### Level 1 - Otherworldly Patron

In your profane research you have rediscovered, contacted, or forged a bargain with an otherworldly entity. At 1st level, you choose an Otherworldly Patron that best represents the entity you entered a Pact with. Your Otherworldly Patron grants you features at 1st level, and again when you reach 6th, 10th, and 14th level.
...
**Spellcasting Ability.** The manner in which you pursue ever greater power from your patron is defined by the nature of that pursuit: through wit, devotion, or fervor. Choose Intelligence, Wisdom, or Charisma to be your spellcasting ability. Once you make this choice, you cannot change it. You use the chosen ability whenever a spell refers to your spellcasting ability.
...
Additionally, when you gain a level in this class, you can choose one of the invocations you know and replace it with another invocation that you could learn at that level. If you should gain a bonus invocation, they do not count against your Invocations known.
...
* When you attack with the weapon, you can use your spellcasting ability modifier for the attack and damage rolls, instead of using Strength or Dexterity. This weapon also counts as magical for the purpose of overcoming resistance and immunity to nonmagical attacks and damage.
* If the weapon has the Thrown property, the weapon returns to your hand immediately after hitting or missing a target.
* By performing a 1 hour ritual while holding a magic or rare weapon, you can transform it into your pact weapon. If this weapon has a bonus to attack or damage rolls, or if it deals bonus damage, you can apply these to your Eldritch Blast.
* You can use the weapon as a spellcasting focus.
...
The weapon ceases being your pact weapon if you die, if you perform the ritual on a different weapon, or if you use a 1 hour ritual to break your bond to it. The weapon is collected by your patron if the bond breaks while it is in the extradimensional space. The weapon disappears if it is more than 5 feet away from you for 1 minute or more. It also disappears if you use this feature again, if you dismiss the weapon (no action required), or if you die.
...
* As an action, you can use what your familiar sees and hear what it hears until the end of your next turn.
...
* Your total number of Invocations Known increases by 1.
...
* At the end of each short or long rest, you can use the Pact Chalice to conjure a vial of the following: alchemist's fire, acid, holy water, potion of healing, or potion of climbing. The liquid retains its potency until the end of your next long rest, at which point it becomes inert and unusable.
...
* When you make an ability check, attack roll, or saving throw, you can choose to reroll after you roll. Once you use this feature, you must finish a short or long rest before you can use it again.

Your Pact Hourglass disappears if it is more than 5 feet away from you for 1 minute, if you use this feature again, if you dismiss your Hourglass (no action required), or you die.

*Feature Upgrade.* When you reach 5th level as a Warlock, the hourglass allows you to use your reaction to use your Rewind feature on a creature that you can see within 60 feet.
...
At certain Warlock levels you unlock more of these esoteric secrets. You learn one additional Arcanum of your choice at 13th level, one at 15th level, and a final Arcanum at 17th level.

<hr>

#### Level 20 - Pact Master
