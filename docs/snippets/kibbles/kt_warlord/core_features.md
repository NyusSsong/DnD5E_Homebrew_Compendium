...
**Hit Points at Higher Levels:** 1d8 (5) + your Constitution modifier per Warlord level after 1st  
...
#### Level 1 – Warlord Presences

At 1st level, you pick the archetype of Warlord you embody, called a Presence, choosing from Commander, Chieftain, Noble, Packleader, Paragon, or Tactician, each of which is detailed at the end of the class description. Your Presence grants you features at 1st level, and again at 3rd, 7th, 11th, 15th, and 18th level.

<hr>

#### Level 1 – Battlefield Presence
...
Any additional attacks granted that are unused at the start of your next turn are lost. A friendly creature can only gain one additional attack per round from this feature.

<hr>

#### Level 2 – Leadership Dice
...
You know three such features: Rallying Mark, Urgent Orders, and Helpful Word. When you gain this feature, you can spend one Leadership Die per turn. Starting at 6th level, you can spend two Leadership Dice per turn. The number you can expend increases to three at 11th level, and to four at 17th level.
...
When you reach 4th level, and again at 8th, 10th, 12th, 16th, and 19th level, you can increase one ability score of your choice by 2, or increase two ability scores of your choice by 1. As normal, you can’t increase an ability score above 20 using this feature.
...
#### Level 6 – Prepare for Battle

Starting at 6th level, you can spend a minute preparing creatures for combat. You can expend a number of Leadership Dice up to your per-turn limit, rolling them and causing up to five creatures of your choice (including yourself, if you choose) to gain temporary hit points equal to the number rolled.

Allies that benefit from this ability can expend a number of Hit Dice equal to the number of Leadership Dice you expended, using them as they would during a short rest. Any temporary hit points gained this way last until you complete a short or long rest.
...
#### Level 13 – Warlord’s Intuition

Starting at 13th level, before rolling an ability check you are proficient in, you can choose for the d20 roll to equal your Warlord level instead of rolling. Once you use this feature, you can't use it again until you finish a long rest.

<hr>

#### Level 14 – Shift the Field

Starting at 14th level, you gain the ability to relocate friendly creatures. As an action, you can expend one Leadership Die to move up to five friendly creatures that can see or hear you up to half their movement speed without provoking opportunity attacks.

<hr>

#### Level 17 – Unbreakable Will

Starting at 17th level, you are immune to the frightened and charmed conditions.

<hr>

#### Level 20 – Tireless Leader
