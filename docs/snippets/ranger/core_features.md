...
**Tools:** One from herbalism kit, navigator’s kit, poisoner’s kit, and a musical instrument  

**Saving Throws:** Strength, Dexterity  
**Skills:** Three from Animal Handling, Athletics, Insight, Investigation, Nature, Perception, Stealth, and Survival  
...
#### Level 1 - Exploration Knacks

n the wild, you have learned bits of primal knowledge,
...
**Preparing and Casting Spells.** The Ranger table above shows how many spell slots you have to cast spells. To cast a Ranger spell of 1st-level or higher, you must expend a slot of the spell's level or higher. You regain all of your expended spell slots when you finish a long rest. 
...
**Ritual Casting.** Your knowledge of the natural world allows you to draw out its innate magic. You can cast any Ranger spell that you have prepared as a ritual so long as that spell has the ritual tag.

<hr>

#### Level 3 - Ranger's Conclave

At 3rd level, you choose your Conclave, a loose association of Rangers that share similar abilities, each of which is detailed at the end of this class description.

Your Ranger Conclave grants you features at 3rd level, and again at 7th, 11th, and 15th level in this class.

**Conclave Spells.** Each Ranger Conclave has a list of Conclave Spells that you always have prepared once you reach the Ranger levels noted in your Conclave's description. Your Conclave Spells count as Ranger spells for you, but they do not count against your total number of spells that you can prepare each day.
...
#### Level 8 - Explorer's Instinct

At 8th level, whenever you learn a new Ranger Exploration Knack or replace an existing one, you can choose from Druid Secrets of Nature, Fighter Soldiering Knacks, or Rogue Skill Tricks.
