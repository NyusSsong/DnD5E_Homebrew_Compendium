...
You create a bond with nature that takes the form of an animal companion. You must choose a beast with a Challenge Rating of 1/4 or lower. You can only have one animal companion at the same time.

If your animal companion dies, you can link yourself to another beast after you spend a week meditating in the terrain where you can find the beast.

Your animal companion obeys your orders (no action required) as best as it can. It has its own initiative as any other creature (unless you are riding it), but otherwise you determine its actions and choices.

If you are incapacitated or for any reason are not able to command your animal companion, it focuses on protecting you and your companions. 
...
to cold damage. Also, you and creatures of your choice who travel with you (maximum 10), have advantage on saving throws to resist the negative effects of arctic environments.
...
#### Fell Handed II
*Prerequisites: 9th-level Ranger, Fell Handed I*
...
The critical hit range resets when you finish a short or long rest.
...
#### Hedge Knight II
*Prerequisites: 3rd-level Ranger, Hedge Knight I*
...
You have a deep knowledge of plants and their healing properties. You have advantage on Intelligence (Nature) checks to identify the medicinal properties of plants. You gain proficiency with herbalism kits, and you automatically succeed on your Wisdom (Medicine) checks to stabilize creatures at 0 hit points if you use a herbalism kit.

#### Herbalist II
*Prerequisites: 3rd-level Ranger, Herbalist I*

You have learned to use natural plants and herbs to create healing salves. Over the course of a long rest, you can spend 1 hour using an herbalism kit to create one *potion of healing*. These potions retain their potency until the end of your next long rest, at which point they become inert.

#### Herbalist III
*Prerequisites: 6th-level Ranger, Herbalist I, II*

When you use your herbalism kit to craft *potions of healing* during a long rest, you craft a number of potions equal to 1 + your Wisdom modifier (minimum of +1).
...
Also, you have advantage when making Wisdom (Nature) checks to use the Study a Creature action regarding beasts or plants you see.

#### Natural Regeneration
*Prerequisites: 3rd-level Ranger*
...
#### Rider II
*Prerequisites: 3rd-level Ranger, Rider I*
...
#### Rider III
*Prerequisites: 6th-level Ranger, Rider I, II*
...
#### Slayer II
*Prerequisites: 6th-level Ranger, Slayer I*
...
#### Slayer III
*Prerequisites: 14th-level Ranger, Slayer I, II*
...
#### Stalker II
*Prerequisites: 3rd-level Ranger, Stalker I*
...
#### Stalker IV
*Prerequisites: 14th-level Ranger, Stalker I, II, III*
...
#### Strider IV
*Prerequisites: 14th-level Ranger, Strider I, II, III*
...
#### Survivor II
*Prerequisites: 9th-level Ranger, Survivor I*
...
#### Survivor III
*Prerequisites: 14th-level Ranger, Survivor I, II*
...
You can construct natural traps. Over the course of 10 minutes, which can be during a short or long rest, you can use a knife, natural materials, and expend 10 feet of rope to craft a trap.
...
#### Wild Insight II
*Prerequisites: 3rd-level Ranger, Wild Insight I*
...
#### Wild Insight III
*Prerequisites: 9th-level Ranger, Wild Insight I, II*
...
#### Woodsman II
*Prerequisites: 3rd-level Ranger, Woodsman I*
