Bomb formulae are summarized in the table below. Formulae marked with an asterisk (✦) are exclusively available through a specific Field of Study and cannot be chosen freely. Unless otherwise stated, all bombs produce a loud boom audible out to one mile. Bombs are presented in alphabetical order.
...
*Available exclusively to Dynamo Engineer Alchemists (6th level).*

By adding an unexpended dynamo to the bomb (and thus expending its spell slot), you can change it into an arcano bomb. An arcano bomb deals force damage instead of fire damage, has d12 damage dice, and deals an additional die of damage, as if a reagent die were added to it.
...
*Available exclusively to Amorist Alchemists.*
...
By adding an ounce of polyjuice, an unpredictable, multicolored chemical, to your bomb's explosive contents, you can change it into a prismatic bomb. A prismatic bomb deals randomly determined damage instead of fire damage, has d8 damage dice, and requires a randomly determined saving throw. Roll on each of the following tables.

??? table "Prismatic Results"
...
*Available exclusively to Apothecary Alchemists.*
...
*Available exclusively to Mad Bomber Alchemists.*

By augmenting your bomb's explosive contents with metal bearings, you can change it into a shrapnel bomb. A shrapnel bomb deals piercing damage instead of fire damage, has d8 damage dice, and explodes in a 10-foot radius.

---

#### Slime Bomb

*Available exclusively to Ooze Rancher Alchemists.*
...
By replacing your bomb's explosive contents with a delayed explosive, you can change it into a thermobaric bomb. A thermobaric bomb has d6 damage dice and explodes in a 10-foot radius sphere.

---

#### Venom Bomb

*Available exclusively to Venomsmith Alchemists.*
