...
<select id="subclass-select" class="filter-select">
    ...
    <option value="bloodwrath">Bloodwrath Guardian</option>
    <option value="grey-watchman">Grey Watchman</option>
    <option value="nightgaunt">Nightgaunt</option>
    <option value="soulblood">Soulblood Shaman</option>
    <option value="stoneheart">Stoneheart Defender</option>
    <option value="storm">Storm Sentinel</option>
    <option value="verdant">Verdant Protector</option>
</select>

<div class="subclass-content" data-subclass="bloodwrath">

??? subclass "Bloodwrath Guardian"
    ...
    ### Level 20 - Form of the Primal Beast
...
<div class="subclass-content" data-subclass="grey-watchman">

??? subclass "Grey Watchman"
...
<div class="subclass-content" data-subclass="soulblood">

??? subclass "Soulblood Shaman"
...
<div class="subclass-content" data-subclass="storm">
...
<div class="subclass-content" data-subclass="verdant">

??? subclass "Verdant Protector"
    ...
    ### Level 20 - Form of the Oak Sentinel
